...
DomainErrorTranslator._directories = {
  ...
  'NEW_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat thread baru karena terdapat parameter yang dibutuhkan tidak ada'),
  ...
  'NEW_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat comment baru karena terdapat parameter yang dibutuhkan tidak ada'),
  ...
  'NEW_COMMENT.CONTENT_LIMIT_CHAR': new InvariantError('tidak dapat membuat comment baru karena karakter content melebihi batas limit'),
};
